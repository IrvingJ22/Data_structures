...
void mergeSort(vector<int>&arreglo, int inicio, int final){
    if(inicio<final){
        ...
        mergeSort(arreglo, inicio, mitad); //Dividir parte izquierda del arreglo
        mergeSort(arreglo, mitad+1, final); //Dividir la parte derecha del arreglo
